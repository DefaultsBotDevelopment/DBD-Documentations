...
| `licenseKey` | The license key, this is used to verify your license. you can get this key from the [license page](/docs/information/activations) |
...
| `tribeStats` | When enabled this leaderboard will display tribe stats             |
