...
<Tabs>
<TabItem value="arkutilitybot" label="Utility Bot">
...
| ----------------------- | :---------------------------------------------- |
| `Auctions Module`       | [Link](/docs/arkutilitybot/modules/auctions)    |
| `Changelogs Module`     | [Link](/docs/arkutilitybot/modules/changelog)   |
| `Controller Module`     | [Link](/docs/arkutilitybot/modules/controller)  |
| `Embedder Module`       | [Link](/docs/arkutilitybot/modules/embedder)    |
| `Polls Module`          | [Link](/docs/arkutilitybot/modules/polls)       |
| `Recruiting Module`     | [Link](/docs/arkutilitybot/modules/recruiting)  |
| `Reporting Module`      | [Link](/docs/arkutilitybot/modules/reporting)   |
| `Requests Module`       | [Link](/docs/arkutilitybot/modules/request)     |
| `Responder Module`      | [Link](/docs/arkutilitybot/modules/responder)   |
| `Selling Module`        | [Link](/docs/arkutilitybot/modules/selling)     |
| `Suggestions Module`    | [Link](/docs/arkutilitybot/modules/suggestions) |
| `Welcomer Module`       | [Link](/docs/arkutilitybot/modules/welcomer)    |
| `Wipe Countdown Module` | [Link](/docs/arkutilitybot/modules/wipe)        |
