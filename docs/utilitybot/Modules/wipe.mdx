...
The translations are located in the `config.js` file like the configuration options. The translations are located in the `wipe_countdown` section inside the `translations` object.
