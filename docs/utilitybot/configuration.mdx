...
| `trade_cancel_modal_could_not_delete_channel` | "The trade channel could not be deleted. Please delete it manually."                        | The message that should be sent when something went wrong while trying to delete the trade channel. |
